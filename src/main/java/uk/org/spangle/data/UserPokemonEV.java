...
public class UserPokemonEV {
    ...
    public UserPokemonEV() {
        // this form used by Hibernate
    }

    public UserPokemonEV(UserPokemon userPokemon, Stat stat, int value) {
    ...
    @Column(name="user_pokemon_ev_id")
    public int getId() {
        return id;
    }
